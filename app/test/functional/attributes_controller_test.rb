...
class AttributesControllerTest < ActionController::TestCase
  ...
  test "should create attribute" do
    assert_difference('Attribute.count') do
      post :create, attribute: { attribute_id: @attribute.attribute_id, attribute_name: @attribute.attribute_name }
    end
  ...
  test "should update attribute" do
    put :update, id: @attribute, attribute: { attribute_id: @attribute.attribute_id, attribute_name: @attribute.attribute_name }
    assert_redirected_to attribute_path(assigns(:attribute))
  end
